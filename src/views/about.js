export const renderAboutView = () => {
    ...
    const aamcLink = document.createElement("a");
    aamcLink.href = "https://store.aamc.org/online-only-official-mcat-prep-bundle.html";
    aamcLink.target = "_blank";
    aamcLink.rel = "noreferrer noopener";
    aamcLink.textContent = "official AAMC materials";
    aiNote.append("OpenMCAT uses generative AI for its practice questions. Use them for drilling and review but verify uncertain explanations. Use ", aamcLink, " for representative MCAT practice.");
    ...
    licenseLink.href = "https://github.com/Zushah/OpenMCAT/blob/main/LICENSE.md";
    licenseLink.target = "_blank";
    licenseLink.rel = "noreferrer noopener";
    licenseLink.textContent = "GNU Affero General Public License v3.0";
    github.append("OpenMCAT has its source code openly available on a ", githubLink, " under the ", licenseLink, ".");
